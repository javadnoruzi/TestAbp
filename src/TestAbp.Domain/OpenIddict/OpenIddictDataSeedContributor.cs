...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("TestAbp") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "TestAbp", DisplayName = "TestAbp API", Resources = { "TestAbp" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Blazor Client
        var blazorClientId = configurationSection["TestAbp_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["TestAbp_Blazor:RootUrl"]?.TrimEnd('/');
